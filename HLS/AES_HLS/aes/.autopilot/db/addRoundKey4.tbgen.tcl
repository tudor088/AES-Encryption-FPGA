...
set C_modelName {addRoundKey4}
set C_modelType { void 0 }
set C_modelArgList {
	{ state_data_V int 8 regular {array 16 { 2 2 } 1 1 }  }
	{ roundKey_data_V int 8 regular {array 16 { 1 1 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "state_data_V", "interface" : "memory", "bitwidth" : 8, "direction" : "READWRITE"} , 
 	{ "Name" : "roundKey_data_V", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ roundKey_data_V_address0 sc_out sc_lv 4 signal 1 } 
	{ roundKey_data_V_ce0 sc_out sc_logic 1 signal 1 } 
	{ roundKey_data_V_q0 sc_in sc_lv 8 signal 1 } 
	{ roundKey_data_V_address1 sc_out sc_lv 4 signal 1 } 
	{ roundKey_data_V_ce1 sc_out sc_logic 1 signal 1 } 
	{ roundKey_data_V_q1 sc_in sc_lv 8 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "roundKey_data_V_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "roundKey_data_V", "role": "address0" }} , 
 	{ "name": "roundKey_data_V_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "roundKey_data_V", "role": "ce0" }} , 
 	{ "name": "roundKey_data_V_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "roundKey_data_V", "role": "q0" }} , 
 	{ "name": "roundKey_data_V_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "roundKey_data_V", "role": "address1" }} , 
 	{ "name": "roundKey_data_V_ce1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "roundKey_data_V", "role": "ce1" }} , 
 	{ "name": "roundKey_data_V_q1", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "roundKey_data_V", "role": "q1" }}  ]}
...
set Spec2ImplPortList { 
	...
	roundKey_data_V { ap_memory {  { roundKey_data_V_address0 mem_address 1 4 }  { roundKey_data_V_ce0 mem_ce 1 1 }  { roundKey_data_V_q0 mem_dout 0 8 }  { roundKey_data_V_address1 mem_address 1 4 }  { roundKey_data_V_ce1 mem_ce 1 1 }  { roundKey_data_V_q1 mem_dout 0 8 } } }
}
