...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    id 17 \
    name roundKey_data_V \
    reset_level 1 \
    sync_rst true \
    dir I \
    corename roundKey_data_V \
    op interface \
    ports { roundKey_data_V_address0 { O 4 vector } roundKey_data_V_ce0 { O 1 bit } roundKey_data_V_q0 { I 8 vector } roundKey_data_V_address1 { O 4 vector } roundKey_data_V_ce1 { O 1 bit } roundKey_data_V_q1 { I 8 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'roundKey_data_V'"
}
}
