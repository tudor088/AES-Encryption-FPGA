...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    reset_level 1 \
    sync_rst true \
    corename {stream_in_key} \
    metadata {  } \
    op interface \
    ports { stream_in_key_TDATA { I 128 vector } stream_in_key_TVALID { I 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { stream_in_key_TKEEP { I 16 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { stream_in_key_TSTRB { I 16 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { stream_in_key_TUSER { I 1 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { stream_in_key_TLAST { I 1 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { stream_in_key_TID { I 1 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { stream_in_key_TREADY { O 1 bit } stream_in_key_TDEST { I 1 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { state_data_V_address0 { O 4 vector } state_data_V_ce0 { O 1 bit } state_data_V_we0 { O 1 bit } state_data_V_d0 { O 8 vector } state_data_V_address1 { O 4 vector } state_data_V_ce1 { O 1 bit } state_data_V_we1 { O 1 bit } state_data_V_d1 { O 8 vector } } \
} "
} else {
