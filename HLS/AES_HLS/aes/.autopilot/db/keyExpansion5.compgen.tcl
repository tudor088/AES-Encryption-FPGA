...
set ID 12
set MemName keyExpansion5_sbobkb
...
# Memory (RAM/ROM)  definition:
set ID 13
set MemName keyExpansion5_rcocud
set CoreName ap_simcore_mem
set PortList { 1 }
set DataWd 8
set AddrRange 11
...
set TrueReset 0
set IsROM 1
set ROMData { "00000001" "00000010" "00000100" "00001000" "00010000" "00100000" "01000000" "10000000" "00011011" "00110110" "00000000" }
set HasInitializer 1
set Initializer $ROMData
set NumOfStage 2
set MaxLatency -1
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    id 14 \
    name masterKey_data_V \
    reset_level 1 \
    sync_rst true \
    dir I \
    corename masterKey_data_V \
    op interface \
    ports { masterKey_data_V_address0 { O 4 vector } masterKey_data_V_ce0 { O 1 bit } masterKey_data_V_q0 { I 8 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'masterKey_data_V'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir IO \
    corename expandedKey_V \
    op interface \
    ports { expandedKey_V_address0 { O 8 vector } expandedKey_V_ce0 { O 1 bit } expandedKey_V_we0 { O 1 bit } expandedKey_V_d0 { O 8 vector } expandedKey_V_q0 { I 8 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'expandedKey_V'"
}
}
