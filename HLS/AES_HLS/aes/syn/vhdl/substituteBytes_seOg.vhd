...
entity substituteBytes_seOg_rom is 
    generic(
             dwidth     : integer := 8; 
             awidth     : integer := 8; 
...
architecture rtl of substituteBytes_seOg_rom is 
...
entity substituteBytes_seOg is
    generic (
        DataWidth : INTEGER := 8;
...
architecture arch of substituteBytes_seOg is
    component substituteBytes_seOg_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    substituteBytes_seOg_rom_U :  component substituteBytes_seOg_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
