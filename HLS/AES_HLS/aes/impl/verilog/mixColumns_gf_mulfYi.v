...
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module mixColumns_gf_mulfYi_rom (
...
initial begin
    $readmemh("./mixColumns_gf_mulfYi_rom.dat", ram0);
    $readmemh("./mixColumns_gf_mulfYi_rom.dat", ram1);
end
...
mixColumns_gf_mulfYi_rom mixColumns_gf_mulfYi_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
