...
entity keyExpansion5_sbobkb_rom is 
    generic(
             dwidth     : integer := 8; 
             awidth     : integer := 8; 
...
architecture rtl of keyExpansion5_sbobkb_rom is 
...
entity keyExpansion5_sbobkb is
    generic (
        DataWidth : INTEGER := 8;
...
architecture arch of keyExpansion5_sbobkb is
    component keyExpansion5_sbobkb_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    keyExpansion5_sbobkb_rom_U :  component keyExpansion5_sbobkb_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
